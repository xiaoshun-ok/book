...
<!-- 	<view class="loginBg">
	...
	<view class="login">
		<view class="content">
			...
			<!-- 主体表单 -->
			<!-- <view class="main"> -->
				<view autocomplete="off" class="main"  >
						<form @submit="formSubmit" >
							...
							<button type="primary" formType="submit"  class="btn-row-submit" >登陆</button> -->
								...
								<wInput
									type="text"  placeholder-class="cl-white" class="flexIcon-text"  name="username" placeholder="请输帐号" 
								></wInput>
								<wInput
									type="password" placeholder-class="cl-white" class="flexIcon-text"  name="password" placeholder="请输入登录密码" 
								></wInput>
							<button type="primary" formType="submit"  class="btn-row-submit" >登陆</button>
							<wButton 
								text="登 录"
...
<script>
	...
	export default {
		components: {uniPopup,wInput,wButton},
		mixins:[user],
		data:function(){
			return {
